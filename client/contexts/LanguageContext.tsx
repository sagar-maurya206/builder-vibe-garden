...
const translations = {
  en: {
    ...
    'form.description.placeholder': 'Detailed description of your improvement idea',
    ...
    'form.uploadImage.hint': 'Maximum 3MB, images will be compressed automatically',
  ...
  hi: {
    ...
    'form.uploadImage.hint': 'अधिकतम 3MB, छवियां स्वचालित रूप से संकुचित हो जाएंगी',
